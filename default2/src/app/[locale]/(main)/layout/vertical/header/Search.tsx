  ...
  return (
    <Dialog open={openModal} onOpenChange={setOpenModal}>
      <DialogTrigger asChild>
        <button className="h-10 w-10 hover:text-primary hover:bg-lightprimary rounded-full flex justify-center items-center cursor-pointer">
          <Icon icon="solar:magnifer-line-duotone" height={20} />
        </button>
      </DialogTrigger>
      <DialogContent className="w-full max-w-2xl p-0 gap-0 [&>button]:hidden rounded-3xl">
