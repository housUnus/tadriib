...
const columns = [
    ...
    cell: (info) => (
      <div className='flex gap-3 items-center'>
        ...
        <div className='truncate line-clamp-2 max-w-56'>
          ...
          <p className='text-sm text-ld'>{info.row.original.post}</p>
        </div>
      </div>
    ),
    header: () => <span className='text-ld'>User</span>,
  }),
  columnHelper.accessor('pname', {
    header: () => <span className='text-ld'>Project Name</span>,
    cell: (info) => <p className='text-ld text-base'>{info.getValue()}</p>,
  }),
  columnHelper.accessor('teams', {
    header: () => <span className='text-ld'>Team</span>,
    cell: (info) => (
      <div className='flex'>
  ...
  columnHelper.accessor('status', {
    header: () => <span className='text-ld'>Status</span>,
    cell: (info) => (
      <Badge
  ...
  columnHelper.accessor('budget', {
    header: () => <span className='text-ld'>Budget</span>,
