      ...
      <CardBox>
        <div className="grid grid-cols-12 gap-4 items-center">
          <div className="col-span-6">
            <h5 className="card-title text-ld mb-4">Yearly Breakup</h5>
            ...
            <div className="flex items-center mb-3 mt-1 gap-2">
              ...
              <p className="text-ld mb-0 text-sm">last year</p>
            </div>
            <div className="flex gap-3 items-center mt-8">
              <div className="flex gap-2 items-center">
                <span className="h-2 w-2 rounded-full bg-primary"></span>
                <span className="text-xs text-ld">2023</span>
              </div>
              <div className="flex gap-2 items-center">
                <span className="h-2 w-2 rounded-full bg-lightsecondary"></span>
                <span className="text-xs text-ld">2024</span>
              </div>
            </div>
          </div>
          <div className="col-span-6">
