          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="xl:col-span-7 col-span-12">
              <div className="flex flex-wrap lg:gap-12 gap-6">
                <div>
                  <h3 className="text-primary lg:text-6xl text-5xl leading-tight font-normal">2019</h3>
                  <span className="text-sm text-dark opacity-90">When we founded Modernize</span>
                </div>
                <div>
                  <h3 className="text-primary lg:text-6xl text-5xl leading-tight font-normal">300k+</h3>
                  <span className="text-sm text-dark opacity-90">Customers on Modernize</span>
                </div>
                <div>
                  <h3 className="text-primary lg:text-6xl text-5xl leading-tight font-normal">25k+</h3>
