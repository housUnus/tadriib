...
const SalesFromLocation = () => {
  ...
  const SalesFromLocationData: { name: string; percentage: number; color: Variant }[] = [
    {
      name: "LA",
      percentage: 28,
      color: "primary",
    ...
    <>
      <CardBox className="">
        <div>
          ...
          <div className="mt-6">
            <VectorMap id="vector-map" height={238} bounds={bounds}>
              <Size height={220}  />
              <Layer
              ...
              >
                ...
                <div className="xl:col-span-8 lg:col-span-6  col-span-7">
                  ...
                  <Progress
                    ...
                    className={`h-2 bg-muted [&>div]:bg-${item.color}`}
                  />
                </div>
