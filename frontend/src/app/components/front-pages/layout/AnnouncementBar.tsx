...
const AnnouncementBar = () => {
  ...
  return (
    <>
      {isVisible && (
        <div className="bg-sky py-2 overflow-hidden relative  before:absolute before:left-0 lg:before:inline-block before:lg:none before:hidden before:content-[''] before:bg-[url('/images/front-pages/background/left-shape.png')] before:bg-no-repeat before:bg-contain before:top-0  before:w-[325px] before:h-[50px]   after:absolute after:end-1/4 lg:after:inline-block after:lg:none after:hidden after:content-[''] after:bg-[url('/images/front-pages/background/right-shape.png')] after:bg-no-repeat after:bg-contain after:top-0  after:w-[325px] after:h-[50px]">
