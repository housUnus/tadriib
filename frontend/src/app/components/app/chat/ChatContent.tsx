...
const ChatContent = ({ onClickMobile }: Props) => {
  const { selectedChat, chatData }: any = useContext(ChatContext)
              ...
              <div className='flex items-center md:gap-2 gap-1'>
                <div className='btn-circle-hover cursor-pointer sm:h-10 sm:w-10'>
                  <Icon
                    ...
                    height={25}
                    className='sm:h-10 h-5 text-darklink dark:text-bodytext'
                  />
                </div>
                <div className='btn-circle-hover cursor-pointer sm:h-10 sm:w-10'>
                  <Icon
      ...
      <div className='flex  '>
        <div
          ...
          <div
            ...
            } border-ld h-full flex flex-col`}>
        ...
        <Activity mode={isRightSide ? 'visible' : 'hidden'}>
          <>
            <div
              className={`shrink-0 ${
                !isRightSide ? 'max-w-[0]' : 'xl:max-w-[300px] max-w-0 w-full'
              }`}>
              <ChatInsideSidebar />
            </div>
