      ...
      return Object.keys(filters).every((key) => {
        ...
        if (key === 'courses') {
          return item.courses.some((course) =>
            course.status.toLowerCase().includes(filterValue)
          )
        }
        return (
          item[key as keyof FilterTableType]
            ?.toLowerCase()
            ...
            <div className='flex sm:flex-row flex-col gap-6   mb-4'>
              <div className='w-full'>
                <input
                  ...
                  className='form-control-input text-ld! py-2! px-4!'
                />
              </div>
              <div className='w-full'>
                <input
                  ...
                  onChange={(e) =>
                    setFilters((prev) => ({ ...prev, courses: e.target.value }))
                  }
              ...
              <div className='w-full'>
                <input
                  ...
                  value={filters.users}
                  onChange={(e) =>
                    setFilters((prev) => ({ ...prev, users: e.target.value }))
                  }
                  className='form-control-input !py-2 !px-4'
                />
              </div>
