                ...
                <div className="flex flex-row">
                  <div>
                    <div className="animateUp">
                      <Image src={"/images/landingpage/background/bannerimg1.png"} alt="matdash" width={410} height={836}/>
                    </div>
                    <div className="animateUp">
                      <Image src={"/images/landingpage/background/bannerimg1.png"} alt="matdash" width={410} height={836} />
                    </div>
                  ...
                  <div>
                    <div className="animateDown">
                      <Image src={"/images/landingpage/background/bannerimg2.png"} alt="matdash" width={410} height={836}/>
                    </div>
                    <div className="animateDown">
                      <Image src={"/images/landingpage/background/bannerimg2.png"} alt="matdash" width={410} height={836}/>
                    </div>
