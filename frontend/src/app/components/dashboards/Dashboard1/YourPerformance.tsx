      ...
      <CardBox>
        ...
        <div className="grid grid-cols-12 mt-6">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="card-subtitle text-sm">Processing</p>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="card-subtitle text-sm">On hold</p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="card-subtitle text-sm">Delivered</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-6 col-span-12 md:-mt-8 mt-4">
            ...
            <p className="card-subtitle text-sm text-center mt-3">
