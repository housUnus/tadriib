...
const TotalSettelment = () => {
  return (
    <>
      <CardBox className="overflow-hidden bg-lightprimary dark:bg-lightprimary h-full">
        <div className="flex gap-4 items-center">
          <span className="h-12 w-12 shrink-0 flex items-center justify-center bg-white rounded-tw">
            <Icon
