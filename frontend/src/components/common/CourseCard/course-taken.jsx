        ...
        <CardContent className="p-0 h-full flex flex-col relative">
          ...
          <Link href={`/learn/${enrollment.id}/lecture`}>
            <div className="relative h-36 sm:h-43 bg-linear-to-br from-gray-100 to-gray-200 rounded-t-xl overflow-hidden">
              <img
                src={
                  enrollment.course.poster || "https://picsum.photos/200/300"
                }
          ...
          <div className="p-2 sm:p-3 flex-1 flex flex-col">
            ...
            <Link href={`/user/${enrollment.course.instructor_slug}`}>
            ...
            <div className="my-2.5">
              <Progress
                value={enrollment?.course_progress_value || 0}
                className="h-1"
              />
              <div className="flex items-center justify-between mt-1.5">
                <span className="text-xs text-muted-foreground">
                  {enrollment?.course_progress_value || 0}% complete
                </span>
